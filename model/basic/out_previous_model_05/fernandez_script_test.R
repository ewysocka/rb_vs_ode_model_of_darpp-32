...
library("randtoolbox")
library("sensitivity")
## sapply(list.files(pattern="[.]R$", path="~/R/R4Kappa/R4Kappa/rkappa_loc/", full.names=TRUE), source);
## source("~/R/R4Kappa/R4Kappa/rkappa_loc/validate.kproject.R")
...
out <- validate.kproject(kproject = fernandezBase, dir='tempd')
